...
export default function SinglePlayerPage() {
  ...
  }, [gameOver, canvasHeight, canvasWidth, birdFrames, birdX, birdY, birdWidth, birdHeight, gravity, jumpStrength, obstacleWidth, obstacleGap, obstacleSpeed, score, obstacles]);
